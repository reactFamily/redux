...
describe('createStore', () => {
    ...
    it('passes the initial action and the initial state', () => {
        const store = createStore(reducers.todos, [{id: 1, text: 'Hello'}]);
    ...
    it('applies the reducer to the previous state', () => {
        ...
        expect(store.getState()).toEqual([{id: 1, text: 'Hello'}, {id: 2, text: 'World'}]);
    });
    ...
    it('preserves the state when replacing a reducer', () => {
        ...
        expect(store.getState()).toEqual([{id: 3, text: 'Perhaps'}, {id: 1, text: 'Hello'}, {id: 2, text: 'World'}]);
    ...
    it('uses the last snapshot of subscribes during nested dispatch', () => {
        const store = createStore(reducers.todos);
    ...
    it('does not allow dispatch() from within a reducer', () => {
        ...
        expect(()=> store.dispatch(dispatchInMiddle(
            store.dispatch.bind(store, unknownAction()))
