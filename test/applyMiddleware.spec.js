...
describe('applyMiddleware', () => {
    ...
    it('works with thunk middleware', done => {
        ...
        store.dispatch(addTodoAsync('Maybe')).then(() => {
            expect(store.getState()).toEqual([{id: 1, text: 'Hello'}, {id: 2, text: 'World'}, {id: 3, text: 'Maybe'}]);
            done();
        });
    });

    it('keeps unwrapped dispatch available while middleware is intializing', () => {
